...
exports.getPostmanCollection = void 0;
const getPostmanCollection = (baseUrl = 'http://localhost:3000') => {
    return {
        info: {
            _postman_id: 'e6a0d4c8-3e4b-4a5c-8971-8d2a5b1c9e01',
            name: 'Event Management REST API Collection',
            description: 'Complete Postman Collection for Event Management REST API with JWT Authentication, RBAC, Events CRUD, Ticket Tiers, Registrations with QR Code, Search & Pagination, and Check-in verification.',
...
exports.getPostmanCollection = getPostmanCollection;
